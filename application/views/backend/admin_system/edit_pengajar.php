...
<div class="panel panel-default">
	...
	<form class="form-horizontal" method="POST" id="barang_form" action="<?php echo base_url().'Admin_System/edit_pengajar_add'; ?>">
		<input type="hidden" name="id_pengajar" value="<?php echo $data_pengajar->id_pengajar ?>">
			...
			<div class="form-group">
				...
				<div class="col-md-2 col-xs-12">
					<select class="form-control" name="nip">
						...
						<option value="<?php echo $a->nip ?>" <?php if($data_pengajar->nip == $a->nip) echo "selected" ?>>
							<?php echo $a->nama ?>
						</option>
						<?php } ?>
					</select>
			...
			<div class="form-group">
				...
				<div class="col-md-2 col-xs-12">
					<select class="form-control" name="id_mapel">
						...
						<option value="<?php echo $b->id_mapel ?>" <?php if($data_pengajar->id_mapel == $b->id_mapel) echo "selected" ?>>
			...
			<div class="form-group">
				...
				<div class="col-md-2 col-xs-12">
					<select class="form-control" name="id_kelas">
						...
						<option value="<?php echo $c->id_kelas ?>" <?php if($data_pengajar->id_kelas == $c->id_kelas) echo "selected" ?>>
							<?php echo $c->kelas ?>
						</option>
						<?php } ?>
					</select>

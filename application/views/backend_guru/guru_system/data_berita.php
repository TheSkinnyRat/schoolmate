    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <div class="text-right">
          ...
          <fieldset>
          <a class="btn btn-success btn-add" href="<?php echo base_url('Guru_System/tambah_berita') ?>"><i class="fa fa-plus"></i> Tambah Data</a>
          <fieldset>
        </div>
      </div>
      <!-- /.panel-heading -->
    ...
    ?>
            <tr>
              ...
              <td class="text-center">
                <a href="<?php echo base_url('Guru_System/edit_berita/'.$u->id_berita); ?>">
              ...
              <td class="text-center">
                <a href="<?php echo base_url('Guru_System/hapus_berita/'.$u->id_berita); ?>">

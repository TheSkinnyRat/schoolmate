    ...
    <?php foreach ($data_video as $u) { ?>
      <div class="panel panel-info">
        ...
        <div class="panel-body">
          ...
          <a class="btn btn-success btn-add" href="<?php echo base_url('Guru_System/download_video/'.$u->id_video); ?>"><i class="fa fa-download"></i> Download Video</a>
          <hr>
          ...
          <?php foreach ($data_komentar as $a) {
            ...
            <blockquote class="blockquote">
              ...
              <?php if ($a->id_guru==$session_userdata['id_guru']) {
                echo anchor('Guru_System/hapus_komentar_video/'.$a->id_komentar, '<h6><i class="fa fa-times"></i> Hapus Komentar</h6>');
              } ?>
            </blockquote>
          <?php } } ?>
        ...
        <div class="panel-footer">
          <form action="<?php echo base_url(). 'Guru_System/komentar_video_add'; ?>" method="post">

    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Selamat Datang, <?php echo $session_userdata['nama'] ?></a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?php echo base_url('Siswa/do_logout') ?>"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                          <a href="<?php echo base_url('Siswa_System') ?>"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>

                        <li>
                          <a href="<?php echo base_url('Siswa_System/data_profile') ?>"><i class="fa fa-user fa-fw"></i> Profile</a>
                        </li>

                        <li>
                          <a href="<?php echo base_url('Siswa_System/data_berita') ?>"><i class="fa fa-newspaper-o fa-fw"></i> Berita</a>
                        </li>

                        <li>
                          <a href="<?php echo base_url('Siswa_System/data_tugas') ?>"><i class="fa fa-tasks fa-fw"></i> Tugas</a>
                        </li>

                        <li>
                          <a href="<?php echo base_url('Siswa_System/data_video') ?>"><i class="fa fa-video-camera fa-fw"></i> Video</a>
                        </li>

                        <li>
                          <a href="<?php echo base_url('Siswa_System/data_posting_admin') ?>"><i class="fa fa-newspaper-o fa-fw"></i> Posting Admin</a>
                        </li>

                        <li>
                          <a href="<?php echo base_url('Siswa/do_logout') ?>" class="text-danger"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>

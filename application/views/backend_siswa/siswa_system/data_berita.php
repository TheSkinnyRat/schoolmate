    ...
    <?php foreach ($data_berita as $u) { ?>
      <div class="panel panel-info">
          ...
          <?php foreach ($data_komentar as $a) {
            ...
            <blockquote class="blockquote">
              ...
              <?php if ($a->id_siswa==$session_userdata['id_siswa']) {
                echo anchor('Siswa_System/hapus_komentar_berita/'.$a->id_komentar, '<h6><i class="fa fa-times"></i> Hapus Komentar</h6>');
              } ?>
            </blockquote>
          <?php } } ?>
        ...
        <div class="panel-footer">
          <form action="<?php echo base_url(). 'Siswa_System/komentar_berita_add'; ?>" method="post">
